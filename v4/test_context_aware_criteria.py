...
def test_enhance_acceptance_criteria():
    ...
    assert (
        "**Context-Aware Requirements:**" in enhanced_task["acceptance_criteria"]
...
def test_generate_methods():
    ...
    code_structure_info = {
        "target_classes": [{"name": "Planner", "methods": ["method1", "method2"]}]
    }

    # Test context integration checks
    checks = planner._generate_context_integration_checks(
