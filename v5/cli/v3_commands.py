...
This module contains V3-specific CLI commands providing basic functionality:
- start: Initialize orchestration loop (with V5 interactive mode)
...
- checkpoints: Manage system checkpoints (list, restore, delete)
...
def cmd_start_interactive(args):
    ...
    if choice == "q":
        ...
        # In production, this would call a orchestrator with the task
    elif choice == "2":
...
def cmd_resume(args):
    ...
    if not session_id:
        ...
        if args.auto:
            # Auto-resume most recent interrupted session
