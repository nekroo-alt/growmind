...
class TestTransaction:
    ...
    def test_transaction_creation(self, mock_checkpoint_manager, mock_telemetry_manager):
    ...
    def test_transaction_with_parent(self, mock_checkpoint_manager, mock_telemetry_manager):
...
class TestTransactionManager:
    ...
    def test_auto_rollback_on_exception(self, transaction_manager, mock_checkpoint_manager):
    ...
    def test_list_transactions_filtered(self, transaction_manager):
        ...
        rolled_back = transaction_manager.list_transactions(TransactionState.ROLLED_BACK)
