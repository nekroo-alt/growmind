...
class ErrorDisplay:
    ...
    def _get_recovery_commands(
        ...
        if operation_id:
            commands.append(("Retry operation", self.RECOVERY_COMMANDS["retry_operation"].format(operation_id=operation_id)))
        
        # Add checkpoint commands
        if checkpoint_id:
            commands.append(("Restore checkpoint", self.RECOVERY_COMMANDS["resume_checkpoint"].format(checkpoint_id=checkpoint_id)))
        
        # Add general commands
        commands.append(("Resume last session", self.RECOVERY_COMMANDS["resume_last"]))
        commands.append(("List checkpoints", self.RECOVERY_COMMANDS["list_checkpoints"]))
