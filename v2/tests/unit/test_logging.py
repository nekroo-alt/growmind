...
class TestFileHandler:
    ...
    def test_file_handler_rotation(self, temp_log_dir):
        ...
        assert (temp_log_dir / "l4d.log.1").exists() or len(list(temp_log_dir.glob("l4d.log.*"))) > 0
...
class TestLogHelperFunctions:
    ...
    def test_log_operation_failed(self, logger):
        ...
        log_operation_failed(logger, "implementation", "timeout", operation_id="abc-123")
        assert True
...
class TestLogLevels:
    ...
    def test_debug_level(self, temp_log_dir):
        ...
        config = LoggingConfig(log_dir=str(temp_log_dir), level="DEBUG", json_format=True)
        config.setup()
    ...
    def test_info_level(self, temp_log_dir):
        ...
        config = LoggingConfig(log_dir=str(temp_log_dir), level="INFO", json_format=True)
        config.setup()
    ...
    def test_warning_level(self, temp_log_dir):
        ...
        config = LoggingConfig(log_dir=str(temp_log_dir), level="WARNING", json_format=True)
        config.setup()
    ...
    def test_error_level(self, temp_log_dir):
        ...
        config = LoggingConfig(log_dir=str(temp_log_dir), level="ERROR", json_format=True)
        config.setup()
    ...
    def test_critical_level(self, temp_log_dir):
        ...
        config = LoggingConfig(log_dir=str(temp_log_dir), level="CRITICAL", json_format=True)
        config.setup()
...
class TestLogTelemetryCorrelation:
    ...
    def test_log_with_session_id(self, temp_log_dir):
        ...
        logger.info("Session started", extra={"session_id": "session-123", "operation_id": "abc-123"})
        logger.info("Session ended", extra={"session_id": "session-123", "operation_id": "def-456"})
...
class TestPerformance:
    ...
    def test_json_vs_text_performance(self, temp_log_dir):
        ...
        # JSON format
        config_json = LoggingConfig(log_dir=str(temp_log_dir / "json"), json_format=True)
        config_json.setup()
        ...
        # Text format
        config_text = LoggingConfig(log_dir=str(temp_log_dir / "text"), json_format=False)
        config_text.setup()
