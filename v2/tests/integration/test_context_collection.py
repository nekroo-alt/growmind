...
class TestContextCollectionWorkflow:
    ...
    def test_v1_vs_v2_context_size_reduction(self, context_engine):
        ...
        assert size_ratio <= 3.0, f"V2 context should be reasonably sized (ratio: {size_ratio})"
    ...
    def test_incremental_context_updates(self, context_engine, workspace_root, tmp_path):
        """
        ...
        # Files were analyzed
        assert update_stats["files_analyzed"] >= 1, "At least one file should be analyzed"
    ...
    def test_token_usage_improvements(self, context_engine):
        ...
        assert total_chars < 50000, f"Context should be concise (got {total_chars} chars)"
    ...
    def test_error_handling_invalid_files(self, context_engine):
        ...
        assert "--- File: v1/data/cache_manager.py" in context or \
               "--- File: v1/logic/context_engine.py" in context
    ...
    def test_cache_invalidation_after_git_changes(self, context_engine, workspace_root):
        ...
        assert stats_final["cache_misses"] > stats_before["cache_misses"], \
