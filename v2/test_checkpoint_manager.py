...
from v2.data.checkpoint_manager import CheckpointManager, get_checkpoint_manager
...
def test_checkpoint_with_filters():
    ...
    id3 = checkpoint.create("Operation 1", snapshot_type="operation_end", operation_id="op1")
