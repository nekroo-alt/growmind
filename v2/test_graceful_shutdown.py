...
class TestSignalHandling:
    ...
    def test_create_shutdown_checkpoint(self, shutdown_handler, mock_checkpoint_manager):
    ...
    def test_create_checkpoint_handles_errors(self, shutdown_handler, mock_checkpoint_manager):
...
class TestIntegrationScenarios:
    ...
    def test_shutdown_during_critical_operation(self, shutdown_handler, mock_checkpoint_manager):
    ...
    def test_shutdown_after_critical_operation(self, shutdown_handler, mock_checkpoint_manager):
