...
def test_smart_file_scoping():
    ...
    print(f"Context length without smart scoping: {len(context_without_smart)} characters")
    print(f"Reduction: {100 * (1 - len(context_with_smart) / len(context_without_smart)):.1f}%")
