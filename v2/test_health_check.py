...
from v2.core.health_check import (
    HealthCheckManager,
    HealthStatus,
    HealthCheckResult,
    HealthReport,
...
class TestHealthCheckManager(unittest.TestCase):
    ...
    def test_check_llm_api_no_keys(self):
        ...
        has_error = any(
            r.name == "llm_api_keys" and r.status == HealthStatus.ERROR
            for r in results
        )
        self.assertTrue(has_error)
    ...
    def test_check_llm_api_with_keys(self):
        ...
        try:
            ...
            self.assertIn(api_key_results[0].status, 
    ...
    def test_calculate_summary(self):
        ...
        checks = [
            ...
            HealthCheckResult(name="check2", status=HealthStatus.WARNING, message="Warning"),
            HealthCheckResult(name="check3", status=HealthStatus.ERROR, message="Error"),
