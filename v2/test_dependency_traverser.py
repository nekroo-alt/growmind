...
from v1.logic.dependency_traverser import DependencyTraverser, DependencyNode
...
"""
    ...
    upstream, depth_levels = traverser.get_upstream_dependencies("main_function", "test.py")
...
"""
    ...
    downstream, depth_levels = traverser.get_downstream_consumers("base_function", "test.py")
...
"""
    ...
    upstream, depth_levels = traverser.get_upstream_dependencies("depth_0", "test.py", max_depth=2)
...
"""
    ...
    upstream, depth_levels = traverser.get_upstream_dependencies("target_function", "test.py")
...
"""
    ...
    upstream, depth_levels = traverser.get_upstream_dependencies("complex_calc", "test.py")
...
"""
    ...
    upstream, depth_levels = traverser.get_upstream_dependencies("function_a", "test.py", max_depth=10)
