...
def test_record_file_write():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert file_ops[0]["diff_summary"] == "Initial file creation", "Should have diff summary"
...
def test_get_file_operations_by_path():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        telemetry.record_file_write(operation_id1, test_file, file_size=100, content_hash="hash1")
        
        operation_id2 = telemetry.start_operation("test", "Test Operation 2")
        telemetry.record_file_read(operation_id2, test_file)
        telemetry.record_file_write(operation_id2, test_file, file_size=150, content_hash="hash2")
        ...
        write_ops = telemetry.get_file_operations_by_path(test_file, operation_type="write")
...
def test_file_operations_with_metadata():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert file_ops[0]["metadata"]["purpose"] == "testing", "Should have purpose metadata"
        assert file_ops[0]["metadata"]["user"] == "test_user", "Should have user metadata"
