...
class ComplexityEstimator:
            ...
            if isinstance(node, ast.FunctionDef) and node.name == function_name:
                ...
                if parent_class:
                    ...
                    while hasattr(current, 'parent'):
                        ...
                        if isinstance(current, ast.ClassDef) and current.name == parent_class:
                            func_ast_node = node
                            break
                else:
                    # Top-level function
    ...
    def calculate_class_complexity(self, class_name: str) -> Dict[str, Any]:
        ...
        max_complexity = max([m["complexity"] for m in method_complexities]) if method_complexities else 0
    ...
    def estimate_task_complexity(self, affected_entities: List[str], 
                                  semantic_map: Optional[Dict] = None) -> Dict[str, Any]:
        """
        ...
        for entity in affected_entities:
            ...
            if func_complexity:
                ...
                if func_complexity["complexity"] > 10:
                    risk_factors.append(f"High complexity function: {entity} ({func_complexity['complexity']})")
                continue
        ...
        estimated_effort = self._estimate_effort_level(total_complexity, len(complexities))
    ...
    def will_exceed_line_limit(self, entity_names: List[str], 
        ...
        for entity in entity_names:
            ...
            if class_complexity:
                ...
                existing_lines += class_complexity["method_count"] * 5  # Conservative estimate
    ...
    def get_refactoring_suggestions(self, complexity_threshold: int = 10) -> List[Dict[str, Any]]:
        """
    ...
    def _count_decision_points(self, node: ast.AST) -> List[Dict[str, int]]:
        ...
        for child in ast.walk(node):
            ...
            if isinstance(child, (ast.If, ast.While)):
                ...
                decision_points.append(location)
            elif isinstance(child, ast.IfExp):  # Ternary expression: x if condition else y
...
def analyze_file_complexity(file_path: str) -> Dict[str, Any]:
    ...
    """
    from v1.data.semantic_mapper import map_file
