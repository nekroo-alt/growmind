...
'''
    ...
    def test_prune_function_with_return(self):
        ...
        pruned = self.pruner.prune_context(
            semantic_mappers, target_entities
        )
    ...
    def test_format_context_as_string(self):
        ...
        formatted = self.pruner.format_context_as_string(
            pruned, include_reasons=True
        )
    ...
    def test_estimate_token_savings(self):
        ...
        original_contexts = {
            "calculate_metrics": self.sample_function_code
        }
    ...
    def test_extract_key_function_lines_with_exception(self):
        ...
        key_lines = self.pruner._extract_key_function_lines(
            mapper, transform_method
        )
    ...
    def test_select_class_methods(self):
        ...
        methods = self.pruner._select_class_methods(
            class_info, dep_entities
        )
