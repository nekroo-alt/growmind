...
def test_cache_invalidation():
    ...
    try:
        ...
        assert stats_after["cache_entries"] == 0, "Cache should be empty after invalidation"
...
""")
        ...
        engine.update_context_incrementally(
            modified_files=["updater_test.py"],
            task_title="Update method task"
        )
        
        stats_after = engine.get_cache_stats()
        assert stats_after["cache_updates"] == cache_updates_before + 1, \
